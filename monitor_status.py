...
def main():
    ...
    results_dir = "results/substep2_task_verification"
    ...
    print("-" * 80)
    ckpt_dir = "substep3_step_detection/checkpoints_graph_test"
    count, files = count_checkpoints(ckpt_dir, "*.pth")
    print(f"  Checkpoint disponibili: {count}/24")
    if count == 24:
        print("  ✅ Completato!")
    ...
    results_dir = "results/substep3_task_graph_matching"
    if check_results_dir(results_dir):
    ...
    results_dir = "results/substep4_gnn_classification"
    if check_results_dir(results_dir):
        print("  ✅ Risultati disponibili")
    else:
    ...
    print("-" * 80)
    data_dirs = {
        "Step embeddings (HiERO)": "extension_localization_hiero/data/step_embeddings_perception.npy",
        "Graph data (Substep 4)": "substep4/graph_classification_substep4/data/metadata.json"
    }
