...
**Input:**
- Step embeddings da Substep 1 (`extension/substep1_step_localization/data/step_embeddings_perception.npy`)
...
**Output:**
- Directory `graph_classification_extension/substep4_gnn_classification/data/` con:
...
python extension/substep4_gnn_classification/prepare_graph_data.py \
    ...
    --output_dir extension/substep4_gnn_classification/graph_classification_extension/substep4_gnn_classification/data \
    --feature_dim 1280 \
    --test_recipes "1,2,3"  # Opzionale: ricette per test split
```

### 2. Dataset (`graph_classification_extension/substep4_gnn_classification/dataset.py`)
...
dataset = TaskGraphDataset(
    root='extension/substep4_gnn_classification/graph_classification_extension/substep4_gnn_classification/data',
    split='train'
)
```

### 3. Model (`graph_classification_extension/substep4_gnn_classification/model.py`)
...
python extension/substep4_gnn_classification/train_gnn_classification.py \
    --data_dir extension/substep4_gnn_classification/graph_classification_extension/substep4_gnn_classification/data \
...
**Output:**
- Checkpoints: `extension/substep4_gnn_classification/checkpoints_gnn/gnn_classifier_recipe_{recipe_id}.pth`
- Training summary: `extension/substep4_gnn_classification/checkpoints_gnn/training_summary.json`
...
python extension/substep4_gnn_classification/train_gnn_classification.py --epochs 50
```
...
```bash
python extension/substep4_gnn_classification/test_pipeline.py
```
...
```
extension/substep4_gnn_classification/
...
├── graph_classification_extension/substep4_gnn_classification/
