...
from extension.substep4_gnn_classification.graph_classification_substep4.model import DAGNNClassifier
from extension.substep4_gnn_classification.graph_classification_substep4.utils import train, test

# Parametri
root = './substep4/extension/substep4_gnn_classification/graph_classification_substep4/data'  # Path aggiornato ai dati
epochs = 50
batch_size = 64
hidden_channels = 64
