...
- [ ] **Step 2.1**: Test import del modulo
  ...
  python -c "import extension/substep1_step_localization; print('OK')"
  ```
...
- [ ] **Step 2.2**: Test su un singolo video
  ```bash
  python extension/substep1_step_localization/test_single_video.py --video_id 10_16
  ```
  **Cosa aspettarsi**:
  - Carica features
...
- [ ] **Step 3.1**: Test su 5-10 video (split test)
  ...
  python extension/substep1_step_localization/run_step_localization.py \
      --split test \
      --output_segments extension/substep1_step_localization/data/step_segments_test.json \
      --output_embeddings extension/substep1_step_localization/data/step_embeddings_test.npy
  ```
  **Cosa aspettarsi**:
...
- [ ] **Step 4.1**: Valida risultati test
  ...
  python extension/substep1_step_localization/validate_step_localization.py \
      --segments extension/substep1_step_localization/data/step_segments_test.json \
      --embeddings extension/substep1_step_localization/data/step_embeddings_test.npy \
      --compare_gt \
      --plot
  ```
  **Cosa aspettarsi**:
...
- [ ] **Step 6.4**: Rilancia con nuovi parametri
  ```bash
  python extension/substep1_step_localization/run_step_localization.py --split test
  ```
...
### Files Generati:
- `extension/substep1_step_localization/data/step_segments_perception.json`
- `extension/substep1_step_localization/data/step_embeddings_perception.npy`
