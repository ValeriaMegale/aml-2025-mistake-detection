...
with open('extension/substep3_task_graph_matching/activity_to_taskgraph.json', 'w') as f:
    json.dump(activity_mapping, f, indent=2)
print('\nSaved to extension/substep3_task_graph_matching/activity_to_taskgraph.json')
