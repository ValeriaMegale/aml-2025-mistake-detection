...
try:
    from substep3_step_detection.model.task_graph_matcher import TextEncoder
    from substep3_step_detection.train_task_graph_matching_gpu import (
    ...
    import sys
    sys.path.append('substep3_step_detection')
